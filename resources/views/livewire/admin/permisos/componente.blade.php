                        ...
                        @foreach($permisos as $permiso)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="javascript:void(0)" wire:click="Edit({{ $permiso->id }})" class="btn btn-outline-warning" title="Editar Registro">Editar</a>
                                    <a href="javascript:void(0)" class="btn btn-outline-danger" onclick="Confirm('{{ $permiso->id }}')">Eliminar</a>
                                </td>
