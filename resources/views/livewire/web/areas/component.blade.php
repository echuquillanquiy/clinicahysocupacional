<div class="row" id="table-hover-animation">
    <div class="col-12">
                ...
                <div class="table-responsive">
                    <table class="table table-hover-animation">
                        ...
                        @foreach($areas as $area)
                            <tr>
                                <td>
                                    <span class="font-weight-bold">{{ $area->id }}</span>
                                </td>
                                <td>{{ $area->name }}</td>
                                <td class="text-center">
                                    <a href="javascript:void(0)" wire:click="Edit({{ $area->id }})" class="btn btn-outline-warning" title="Editar Registro">Editar</a>
                                    <a href="javascript:void(0)" class="btn btn-outline-danger" onclick="Confirm('{{ $area->id }}')">Eliminar</a>
                                </td>
        ...
        @include('livewire.web.areas.form')
    </div>
</div>
